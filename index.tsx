...
const Sidebar = ({ activeSection, setActiveSection, sections }) => {
    const logoBase64 = 'data:image/jpeg;base64,...';
    return (
        <aside className="w-64 bg-brand-dark text-white flex-col hidden sm:flex">
            <div className="p-4 border-b border-gray-700"><img src={logoBase64} alt="United Pharmacy Logo" className="w-full h-auto" /></div>
