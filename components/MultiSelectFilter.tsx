    ...
    return (
        <div className="flex flex-col relative" ref={wrapperRef}>
            ...
            <button
                ...
                className="w-full p-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-brand-primary focus:border-brand-primary text-sm bg-white dark:bg-gray-700 text-left flex justify-between items-center text-gray-800 dark:text-gray-200"
            >
                     ...
                     <div className="p-2 border-b dark:border-gray-700">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-8 pr-2 py-1.5 border border-gray-300 dark:border-gray-600 rounded-md text-sm bg-white dark:bg-gray-700"
                            />
                        </div>
                    </div>
